			...
			<div class="panel panel-default">
				...
				<div class="panel-body">
					<div class="form-horizontal" role="form">
						...
						<div class="form-group">
							<label style="text-align: left"  class="col-sm-4 control-label" for="Numeromesa">Numero De Mesa: </label>
							<div class="col-sm-10">
								<asp:TextBox class="form-control" ID="NumeromesaTextBox" placeholder="0" Enabled="true" TextModel="Numer" runat="server"></asp:TextBox>
								  <asp:RequiredFieldValidator ID="Numeromesa" runat="server" MaxLength="200"
                                ControlToValidate="DescripcionTextBox"
                                ErrorMessage="Campo Estudiante obligatorio" ForeColor="Red"
                                Display="Dynamic" SetFocusOnError="True"
                                ToolTip="Campo Numero obligatorio" ValidationGroup="Guardar">Por favor llenar el campo Descripcion
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<asp:TextBox class="form-control" ID="CantidadTextBox" placeholder="0" Enabled="true" TextModel="Numer" runat="server"></asp:TextBox>
							</div>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							<label style="text-align: left" class="col-sm-4 control-label" for="txtmobile">Fecha: </label>
							<div class="col-sm-10">
						...
						<div class="form-group">
							<div class="col-sm-offset-2 col-sm-10">
								...
								<div class="btn btn-success glyphicon glyphicon-floppy-disk">
									<asp:Button ID="GuardarButton" runat="server" Text="Guardar" ValidationGroup="Guardar" BackColor="Transparent" BorderWidth="0"></asp:Button>
								</div>
