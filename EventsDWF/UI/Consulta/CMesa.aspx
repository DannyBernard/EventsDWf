<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="CMesa.aspx.cs" Inherits="EventsDWF.UI.Consulta.CMesa" %>
				...
				<div class="panel-body">
					...
					<div>
						<div class="col-md-2">
							<asp:DropDownList ID="BuscarPorDropDownList" runat="server" CssClass="form-control input-sm">
								...
								<asp:ListItem>Cantidad de Personas</asp:ListItem>
					...
					<div class="form-row ">
						...
						<div class="form-group  col-sm-4 ">
							...
							<asp:TextBox ID="HastaTextBox" CssClass="form-control input-group col-sm-4" TextMode="Date" runat="server" />
						</div>
					</div>
						...
						<asp:GridView ID="DatosGridView"
							...
							<Columns>
								<asp:HyperLinkField ControlStyle-ForeColor="blue"
									DataNavigateUrlFields="MesaId"
									DataNavigateUrlFormatString="~/UI/Registros/RMesas.aspx?Id={0}"
               ...
               <div class="modal-dialog" style="max-width: 1000px!important; min-width: 500px!important">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLabel">Reporte Para Mesas </h5>
                        ...
                        <div class="modal-body">
                            <%--Viewer--%>
                            <rsweb:ReportViewer ID="ReportMesa" runat="server" ProcessingMode="Local" Height="600px" Width="500px">
