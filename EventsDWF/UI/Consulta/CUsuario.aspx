<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="CUsuario.aspx.cs" Inherits="EventsDWF.UI.Consulta.CUsuario" %>
               ...
               <div class="modal-dialog" style="max-width: 1000px!important; min-width: 500px!important">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLabel">Reporte Para Usuario</h5>
                        ...
                        <div class="modal-body">
                            <%--Viewer--%>
                            <rsweb:ReportViewer ID="ReportUsuario" runat="server" ProcessingMode="Local" Height="600px" Width="500px">
